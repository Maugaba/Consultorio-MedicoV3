...
&nbsp; Medicamentos</h1>
        <p>
&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label1" runat="server" Text="Código del medicamento: " style="font-size: large"></asp:Label>
&nbsp; <asp:TextBox ID="TextBoxcodigo" runat="server" Width="181px" BackColor="#CCFFFF"></asp:TextBox>
        </p>
        <p>
            <span class="auto-style1">&nbsp; Nombre del medicamento:&nbsp; </span><asp:TextBox ID="TextBoxnombre" runat="server" Width="135px" BackColor="#CCFFFF" BorderColor="#CCFFFF" CssClass="auto-style1"></asp:TextBox>
        </p>
        <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="Button1" runat="server" Text="Agregar enfermedad" Width="187px" OnClick="Button1_Click" BackColor="#99CCFF" CssClass="auto-style1" />
        </p>
        <p>
